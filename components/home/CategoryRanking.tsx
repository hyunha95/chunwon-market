        ...
        <section className="py-8 md:py-12">
            ...
            <div className="relative isolate mx-1 mb-4 md:mx-2 md:mb-8">
                {canScrollLeft && (
                    <>
                        <div
                            className="pointer-events-none absolute inset-y-0 left-0 z-10 hidden w-20 bg-gradient-to-r from-background/60 via-background/25 to-transparent backdrop-blur-[1px] md:block"/>
                        <button
                            type="button"
                ...
                {canScrollRight && (
                    <>
                        <div
                            className="pointer-events-none absolute inset-y-0 right-0 z-10 hidden w-20 bg-gradient-to-l from-background/60 via-background/25 to-transparent backdrop-blur-[1px] md:block"/>
                        <button
                            type="button"
                                    ...
                                    {pageItems.map((product, idx) => {
                                        ...
                                        return (
                                            <article key={`mobile-${product.id}`} className="flex items-center gap-1.5">
                                                <div
                                                    className="w-5 pt-0.5 text-2xl font-black italic leading-none text-slate-900 self-start">
                                                    {absoluteRank}
                                                </div>
                                                <div className="h-28 w-20 flex-shrink-0 overflow-hidden bg-slate-100">
                                                    <img
                                                        src={product.image}
                                                        alt={product.name}
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <div className="flex items-center gap-1">
                                                        {product.isNew && (
                                                            <span
                                                                className="inline-flex items-center border border-slate-300 px-1 py-0.5 text-[8px] font-bold text-slate-700">
                                NEW
                              </span>
                                                        )}
                                                        <p
                                    ...
                                    {pageItems.map((product, idx) => {
                                        ...
                                        return (
                                            <article key={product.id} className="min-w-0">
                                                <div
                                                    className="mb-1 w-fit border-b border-slate-500 pb-0.5 text-xl font-bold leading-none tracking-tight text-slate-900 md:mb-2 md:pb-1 md:text-4xl">
                                                    {absoluteRank}
                                                </div>

                                                <div
                                                    className="group relative mx-auto w-[88%] aspect-[1/1] overflow-hidden bg-slate-100 md:w-full md:aspect-[4/5]">
                                                    <img
                                                        src={product.image}
                                                        alt={product.name}
                                                    ...
                                                    {product.isHot && (
                                                        <div
                                                            className="absolute bottom-1.5 left-1.5 inline-flex h-7 w-7 items-center justify-center rounded-full bg-pink-600 text-[8px] font-black leading-tight text-yellow-300 md:bottom-3 md:left-3 md:h-10 md:w-10 md:text-[10px]">
                                                            국민
                                                            <br/>
                                                            특템
                                                        </div>
                                                ...
                                                <div className="mx-auto w-[88%] pt-0.5 md:w-full md:pt-3">
                                                    {product.isNew && (
                                                        <div
                                                            className="mb-1 inline-flex items-center border border-slate-300 px-1.5 py-0.5 text-[10px] font-bold text-slate-700 md:mb-2 md:px-2 md:text-xs">
                                                            NEW
                                                        </div>
                                                    )}
                                                    <p
                                                    ...
                                                    <div
                                                        className="mt-1 flex flex-wrap gap-0.5 text-[10px] font-semibold text-slate-700 md:mt-3 md:gap-1.5 md:text-[11px]">
                            <span
                                className="inline-flex items-center gap-0.5 bg-slate-100 px-1 py-0.5 md:gap-1 md:px-1.5 md:py-1">
                              ...
                              오늘
                                                    ...
                                                    <div
                                                        className="mt-1.5 flex items-center gap-0.5 md:mt-3 md:gap-1.5">
                                                        <div className="flex items-center gap-0.5">
                                                            {Array.from({length: 5}).map((_, starIdx) => (
                                                                <Star
                                                                    key={starIdx}
                                                        ...
                                                        <span
                                                            className="text-xs font-semibold text-slate-700 md:text-sm">
                              {formatNumber(product.reviewCount)}
                            </span>
                                                    </div>
                                                </div>
